...
const ALL_SUBJECT_ORDER = ["biology", "civic-education", "english", "mathematics", "general-paper", "music", "physics"].map(id => SUBJECTS.find(subject => subject.id === id));
...
const FAQS = [
  ...
  { group: "Practice and review", q: "Which subjects are available?", a: "Biology, Civic Education, English Language, General Paper, Mathematics, Music and Physics are available. Question banks include verified questions with detailed written explanations." },
