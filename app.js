...
const ALL_SUBJECT_ORDER = ["biology", "chemistry", "civic-education", "computer-studies", "economics", "english", "general-paper", "government", "history", "mathematics", "music", "physics"].map(id => SUBJECTS.find(subject => subject.id === id));
...
const FAQS = [
  ...
  { group: "Practice and review", q: "Which subjects are available?", a: "Biology, Chemistry, Civic Education, Computer Studies, Economics, English Language, General Paper, Government, History, Mathematics, Music and Physics are available. Question banks include verified questions with detailed written explanations." },
